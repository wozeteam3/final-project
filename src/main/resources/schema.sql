...
-- Schema final-project
-- -----------------------------------------------------
CREATE SCHEMA IF NOT EXISTS `final-project` DEFAULT CHARACTER SET utf8 ;
USE `final-project` ;

-- -----------------------------------------------------
-- Table `final-project`.`benefits`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `final-project`.`benefits` (
...
-- -----------------------------------------------------
-- Table `final-project`.`paygrade_hourly`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `final-project`.`paygrade_hourly` (
  `grade` INT NOT NULL,
...
-- -----------------------------------------------------
-- Table `final-project`.`paygrade_salary`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `final-project`.`paygrade_salary` (
  `grade` INT NOT NULL,
...
CREATE TABLE IF NOT EXISTS `final-project`.`employee` (
  ...
  CONSTRAINT `benefit_id`
    ...
    REFERENCES `final-project`.`benefits` (`benefit_id`),
  CONSTRAINT `grade_hour`
    FOREIGN KEY (`pay_grade`)
    REFERENCES `final-project`.`paygrade_hourly` (`grade`),
  CONSTRAINT `grade_sal`
    FOREIGN KEY (`pay_grade`)
    REFERENCES `final-project`.`paygrade_salary` (`grade`))
ENGINE = InnoDB
AUTO_INCREMENT = 15
DEFAULT CHARACTER SET = utf8mb3;
