...
public class EmployeeService {
	...
	private final String CREATE = "INSERT INTO employee"
			+ " (benefit_id,first_name,last_name,email,phone_num,pay_grade,pay_step,salaried) VALUES"
			+ " (?,?,?,?,?,?,?,?)";
	private final String UPDATE = "UPDATE employee SET benefit_id = ?, first_name = ?, last_name = ?, email = ?, phone_num = ?,"
	...
	public static Employee resultToEmp(ResultSet rs) throws SQLException {
		Employee e = new Employee(rs.getInt(1), rs.getInt(2), rs.getString(3), rs.getString(4), rs.getString(5),
