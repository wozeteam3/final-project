...
public class EmployeeService {
	...
	private final String CREATE = "INSERT INTO employee (benefit_id,first_name,last_name,email,phone_num,pay_grade,pay_step,salaried) VALUES (?,?,?,?,?,?,?,?)";
	private final String UPDATE = "UPDATE employee SET benefit_id = ?, first_name = ?, last_name = ?, email = ?, phone_num = ?, pay_grade = ?, pay_step = ?, salaried = ? WHERE emp_id = ?";
